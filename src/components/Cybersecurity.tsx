...
export default function Cybersecurity() {
  ...
  // ✅ certifications array removed

  return (
    <section id="cybersecurity" className="relative py-32 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {securityServices.map((service, idx) => (
            <div
              key={service.title}
              className="group backdrop-blur-xl bg-white/[0.06] border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-red-500/50 transition-all duration-300 hover:scale-105"
        ...
        {/* Security Tools – now takes full width (certifications removed) */}
        <div className="backdrop-blur-xl bg-white/[0.06] border border-white/10 rounded-2xl p-8 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {securityTools.map((tool) => (
              <div
                key={tool.name}
                className="p-4 rounded-xl backdrop-blur-md bg-white/[0.04] border border-white/10 hover:border-red-400/40 hover:bg-white/[0.08] transition-all group cursor-pointer"
              >
        ...
        {/* Security Mindset Statement – unchanged */}
        <div className="mt-20 text-center">
          <div className="backdrop-blur-xl bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/30 rounded-2xl p-12 max-w-4xl mx-auto">
            <svg className="w-16 h-16 text-red-400 mx-auto mb-6" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <h3 className="text-3xl font-bold text-white mb-4">Security-First Development</h3>
